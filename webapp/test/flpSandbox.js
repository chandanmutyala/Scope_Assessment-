		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#scopeassessment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"scopeassessment-display": {
								"semanticObject": "scopeassessment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=scopeassessment",
									"url": sap.ui.require.toUrl("scopeassessment")
								}
							}
						}
					}
